...
If you want to set a target version, UniTask is using `*.*.*` release tag so you can specify a version like `#2.0.20`. For example `https://github.com/Cysharp/UniTask.git?path=src/UniTask/Assets/Plugins/UniTask#2.0.20`.
